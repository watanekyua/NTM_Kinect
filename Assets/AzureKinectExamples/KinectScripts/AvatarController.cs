...
namespace com.rfilkov.components
{
    ...
    //		else
        ...
        protected virtual float GetCorrDistanceToGround(Transform trans, Vector3 initialPos, bool isRightJoint)
        {
            ...
            float fSign = Vector3.Dot(deltaDir, initialUpVector) < 0f ? 1f : -1f;  // opposite, because it's correction
        ...
        protected virtual float GetCorrDistanceToGround()
        {
            if (leftFoot == null && rightFoot == null)
            {
                ...
                leftFootPos = leftFoot != null ? leftFoot.transform.position : Vector3.zero;
                rightFootPos = rightFoot != null ? rightFoot.transform.position : Vector3.zero;
            }
