        ...
        void Update()
        {
            if (sensorData != null)
            {
                ...
                if (isColorCamDepthFramesEnabled)
                {
                    ...
                    {
                        OnNewColorCameraDepthFrame?.Invoke(colorCamDepthFrame, lastColorCamDepthFrameTime);
                ...
                if (isColorCamBodyIndexFramesEnabled)
                {
                    ...
                    {
                        OnNewColorCameraBodyIndexFrame?.Invoke(colorCamBodyIndexFrame, lastColorCamBodyIndexFrameTime);
