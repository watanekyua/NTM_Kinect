...
namespace com.rfilkov.kinect
{
    ...
    public class Kinect4AzureSyncher
    {
        ...
        private const long MAX_TIME_ERROR = 1000;
        ...
        public void UpdateCapture(int sensorIndex, long capTimestamp, Capture capture)
        {
            ...
            lock (syncherLock)
            {
                ...
                {
                    //Debug.Log("Captures not synched. Index: " + sensorIndex + " ThisTime: " + syncherData[sensorIndex].capTimestamp + ", MasterTime: " + syncherData[iMaster].capTimestamp);
                }
            }
        }
