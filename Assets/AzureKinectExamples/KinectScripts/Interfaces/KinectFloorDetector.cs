...
namespace com.rfilkov.kinect
{
    ...
    public class KinectFloorDetector
    {
        ...
        private int binAggregation = 0;
        private int minFloorPointCount = 0;
        private float planeMaxTiltInDeg = 0f;
            ...
            while(isRoutineRunning)
            {
                ...
                if (bPlaneValid)
                {
                    ...
                    if (floorTiltInDeg < planeMaxTiltInDeg)
                    {
                        ...
                        //Debug.Log("Used gravity for normal.");
                    }
                    ...
                    //Debug.Log("Plane pos: " + vPlanePos + ", norm: " + vPlaneNorm + ", rot: " + qSensorRot.eulerAngles + ", ofs: " + vPlaneOfs + ", ofs2: " + vPlaneOfs2);
                }
            }
        }
